...
def capture_histogram(source=0):
    ...
    while True:
        ...
        cv2.rectangle(frame, (100, 100), (400, 400), (105, 105, 105), 2)  # þessi
        # cv2.rectangle(frame, (100, 100), (400, 400), (0, 255, 0), 0) #hinn
        box = frame[100:400, 100:400]  # þessi
        # box = frame[100:400, 100:400] #hinn
